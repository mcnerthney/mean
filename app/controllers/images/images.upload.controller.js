...
module.exports  = function(temporaryFolder) {
    ...
    function validateRequest(chunkNumber, chunkSize, totalSize, identifier, filename, fileSize) {
        ...
        if (typeof(fileSize) !== 'undefined' && fileSize !== null) {
            ...
            console.error('fileSize: ' + fileSize + typeof(fileSize));
            console.error('totalSize: ' + totalSize + typeof(totalSize));
    ...
    $.get = function(req, callback) {
        var chunkNumber = parseInt(req.param('flowChunkNumber', 0));
        var chunkSize = parseInt(req.param('flowChunkSize', 0));
        var totalSize = parseInt(req.param('flowTotalSize', 0));
        var identifier = req.param('flowIdentifier', '');
        var filename = req.param('flowFilename', '');
        console.log('identifier:' + identifier);
        var error = validateRequest(chunkNumber, chunkSize, totalSize, identifier, filename);
        if (error === 'valid') {
            ...
            callback('not_found' + error, null, null, null);
        }
    };
